...
import {ErrorTypeEnum} from "../util/enum/ErrorTypeEnum";
import {environment} from "../config/Config";


export abstract class ApiError extends Error {
  constructor(public type: ErrorTypeEnum, public message: any = 'error') {
    super(type);
  }
...
export class ConflictError extends ApiError {
  constructor(message = 'Resource Conflict Found') {
    super(ErrorTypeEnum.CONFLICT, message);
  }
}
